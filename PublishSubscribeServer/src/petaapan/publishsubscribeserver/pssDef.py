...
REQ_PUBLISHER = 'publisher'         # Google App path that accesses publisher
                                    # module
SUBACTION = 'subscribe'             # Relative URL to Google Apps handler for
                                    # subscription
SUBSCRIBER = 'subscriber'           # URL where subscriber wishes to receive
                                    # notifications.
...
SUBSCRIBER_PORT = 'subscriberPort'  # Port where subscriber wishes to
                                    # receive notifications
SUBSCRIBE = 1                       # User is subscribing to a specified
                                    # publisher
UNSUBSCRIBE = 0                     # User is un-subscribing from a specified
                                    # publisher
